...
keyboard_fix = CUSTOM / "apply_v108_keyboard_fix.py"
if not keyboard_fix.is_file():
    raise SystemExit("missing apply_v108_keyboard_fix.py")
exec(compile(keyboard_fix.read_text(encoding="utf-8"), str(keyboard_fix), "exec"), {"__name__": "__main__", "__file__": str(keyboard_fix)})
